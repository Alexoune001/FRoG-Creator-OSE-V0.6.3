...
i = Items1.ListIndex + 1
    ...
    PlayerInv1.List(Trading(i).InvNum - 1) = Mid$(Trim$(PlayerInv1.List(Trading(i).InvNum - 1)), 1, Len(PlayerInv1.List(Trading(i).InvNum - 1)) - Len("(" & STR$(Trading(i).InvVal) & ")**"))
...
Dim Ending As String
    ...
    For i = 1 To 4
        ...
        If FileExiste(Rep_Theme & "\Jeu\echange" & Ending) Then Me.Picture = LoadPNG(App.Path & Rep_Theme & "\Jeu\echange" & Ending)
    Next i
End Sub
